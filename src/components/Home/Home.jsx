...
const Home = () => {
  ...
  useEffect(() => {
    ...
    .fromTo(heroSocial, {y: "-=20%", opacity: 0}, {y: 0, delay: 0.5, opacity: 1, duration: 1, ease: "power1"}).fromTo(textOverlay, {opacity: 0}, {opacity: 1, duration:1, ease: "power1"}, "<")
  }, []);
      ...
      <div className='home__wrapper'>
        <div className='home__hero'>
          <div className='home__hero__title'>
            ...
            <div className='home__overlay' ref={textOverlayRef}>
